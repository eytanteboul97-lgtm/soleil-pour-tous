        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-ink-soft">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              éligibilité aux aides liées à vos travaux de rénovation
              énergétique (panneaux photovoltaïques, pompes à chaleur,
              isolation, etc.) et vous recontacter dans le cadre de votre
